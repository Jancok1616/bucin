...
// Dirubah 
const pengirim = "Akhii";
const nomorWa = "6282173754746" // awalan nomor 0 harus di awalin 62
const textWa = "Bales ya ukhti,tinggal di pencet doang hehe:)"
const pesan = `oh ya ukhti,kmu jangan cuek-cuek ke ak ya, kan ak jdi kesepian😔,kek tdi malam ak ditinggal tidur aja🥺:( `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Morning Ukhti, oh ya karna ak sering panggil kmu ukhti, aku jadi lupa nama kmu nih, oh ya tulis nama kmu disini ya:)',
    ...
    let txt = `Halo ${result.value.login}, Kamu jangan telat mam ya, jangan lupa mandi juga ya🤭, ${pesan}`;
